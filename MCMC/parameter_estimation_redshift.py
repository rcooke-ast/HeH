...
# Load the model
modtyp = 'UVBredshift'
filename = "data/{0:s}_radiation_uvb_z_data.npy".format(modtyp)
...
zabs, zabserr = 1.724002, 0.001
mn_slp, mx_slp = zabs - zabserr, zabs + zabserr
...
np.save("{0:s}_samples{1:d}_inflate{2:d}_zabsPrior.npy".format(modtyp, nmbr, inflate), sampler.chain)
