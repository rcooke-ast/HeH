...
qsogal=np.loadtxt('radiation_z1p724_uvbqsogal.cnt',dtype={'names': ('nu', 'int', 'phot'),'formats': ('f8', 'f8', 'f8')})
...
plt.plot(np.log10(qsogal['nu']),np.log10(qsogal['int']),label='AGN+Galaxy')
plt.xlim([13,20])
plt.ylim([-10,0])
